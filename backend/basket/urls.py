...
from .views import basket_view, basket_add, basket_update, basket_delete, sendMessageOrderInTelegram
app_name = 'basket'
...
urlpatterns = [
    ...
    path('message/<int:user_id>/', sendMessageOrderInTelegram, name='message'),
]
